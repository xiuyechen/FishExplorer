...
%     DrawClusters(h1,C,unique(gIX),numK,stim,fictive,clrmap,rankscore,iswrite,ispopout);
else
    DrawClusters(h1,M,gIX,numK,stim,fictive,clrmap,rankscore,...
        iswrite,isPopout,isPlotLines,isPlotFictive);
%     DrawClusters(h1,M,gIX,numK,stim,fictive,clrmap,rankscore,iswrite,ispopout);
end
...
% if isCentroid,
%     [C,~] = FindCentroid(gIX,M);
%     DrawClusters(h1,C,unique(gIX),numK,stim,fictive,clrmap,rankscore,iswrite);
% else
%     DrawClusters(h1,M,gIX,numK,stim,fictive,clrmap,rankscore,iswrite);
% end
if isCentroid,
    [C,~] = FindCentroid(gIX,M);
    DrawClusters(h1,C,unique(gIX),numK,stim,fictive,clrmap,rankscore,...
