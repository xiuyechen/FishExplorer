...
for i_taileye = 1%:2
    ...
    if i_taileye==1
        ...
        ClusterIDs = [12,1];
        range_fish = GetFishRange('e');% no fish13
    end    
    ...
    for i_lr = 1:2
        ...
        for i_fish = range_fish
            ...
            [cIX_load,gIX_load,~,~,~,M_0] = LoadSingleFishDefault(i_fish,hfig,[2,1]);
...
%             set(gca,'XTick',0:0.5:1,'YTick',-0.5:0.5:1);
        ...
        if i_taileye == 1
            if i_lr==1
                M_reg_name = {'bubbleplot_L_all_passy','multimotor_L_anat_all_passy'};
            elseif i_lr==2
                M_reg_name = {'bubbleplot_R_all_passy','multimotor_R_anat_all_passy'};
            end
        else
            if i_lr==1
                M_reg_name = {'bubbleplot_Le_all_passy','multimotor_Le_anat_all_passy'};
            elseif i_lr==2
                M_reg_name = {'bubbleplot_Re_all_passy','multimotor_Re_anat_all_passy'};
            end
        end
