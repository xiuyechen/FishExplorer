% the goal of this script is to explore the idea that single-cell GLM
% predictions are worse than cluster based GLM, because single cells are
% often noisy and overfitting becomes a problem. 

% The prelim data for this is that for the A0.7 set of cells, when examining the betas
% for singles cells, the range is much bigger than for cluster based, but
% those large betas values are extremely rare. 
